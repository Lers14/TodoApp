...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { Nombre: @tarea.Nombre, descripcion: @tarea.descripcion, fecha: @tarea.fecha, importancia: @tarea.importancia } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { Nombre: @tarea.Nombre, descripcion: @tarea.descripcion, fecha: @tarea.fecha, importancia: @tarea.importancia } }
